...
public class Game {
	...
	///PRINTS OUT THE INDEX OF THE ARRAYS BETWEEN THE LINES IN ORDER TO MAKE A BOARD :)
	...
	///SUBTRACTED BY 1 SO THE USER DOESNT HAVE TO INPUT 0,1,2 BUT INSTEAD CAN SAY 1,2,3
	public void updateBoard(String player, int row, int column)
	{
	    board[row- 1][column-1]=player;

	}
	/// CHECKS THE INPUT TO SEE IF THE NUMBERS ARE VALID OR IF THE SPOT IS TAKEN
	...
	///COULDN'T FIGURE OUT AN EASY WAY TO DO THIS BUT WE MANUALLY TYPED OUT ALL THE WINNING POSSIBILITIES :')
	...
	public static void main(String[] args) {
		Scanner move = new Scanner(System.in);	///LOOKED UP AN EXAMPLE FOR SCANNER ON STACKOVERFLOW.COM
